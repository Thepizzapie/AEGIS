...
| agent-def-protect | wrote CLAUDE.md/AGENTS.md or a .claude/agents, .claude/commands, .claude/output-styles, or .claude/skills definition (auto-loaded/auto-invoked next session) | ask the human; they can set AEGIS_ALLOW_AGENT_DEF=1 after review |
