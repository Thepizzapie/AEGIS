...
2. Read the policy YAML files it names (they are small) and summarize:
   ...
   `git_hooks`, `hook_manager`, `agent_def`, `skills_protect`, `shell_persist`, `direnv`, `package_manifest`, `pnpmfile_exec`, `git_config_exec`, `git_attributes_exec`, `gitmodules`, `service_persist`, `ld_preload`, `env_hijack`, `devcontainer_exec`, `vscode_tasks_exec`, `path_hijack`, `claude_hooks`, `statusline`, `permission_bypass`, `conftest`, `pysite`, `ipython_startup`, `cloud_cred_exec`, `terraform_exec`, `fetch_to_file`, `inject`, `failures`, `completion`,
...
2. Read the existing YAML; make the smallest change that expresses the intent:
   ...
   - knobs: `default_action`, `egress`, `workspace`, `install_review`,
     ...
     `service_persist`, `ld_preload`, `env_hijack`, `devcontainer_exec`, `vscode_tasks_exec`, `path_hijack`,
