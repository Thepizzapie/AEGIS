...
def load_policy(path) -> Policy:
    ...
    st = {
        ...
        "gitmodules": {},
        "service_persist": {}, "cron_persist": {}, "ld_preload": {}, "devcontainer_exec": {}, "vscode_tasks_exec": {},
...
def _merge_file(data: dict, fname: str, st: dict) -> None:
    ...
    for key in ("install_review", "mcp_config", "ci_workflow", "git_hooks", "hook_manager",
                ...
                "git_attributes_exec", "gitmodules", "service_persist", "cron_persist", "ld_preload",
                "devcontainer_exec",
