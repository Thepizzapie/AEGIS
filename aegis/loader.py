...
def load_policy(path) -> Policy:
    ...
    st = {
        ...
        "shell_persist": {},
        "direnv": {},
        "package_manifest": {}, "pnpmfile_exec": {}, "git_config_exec": {}, "git_attributes_exec": {},
        "gitmodules": {},
        "service_persist": {}, "ld_preload": {}, "exec_env_hijack": {},
        "devcontainer_exec": {}, "vscode_tasks_exec": {},
    ...
    return Policy(rules=st["rules"], default_action=st["default"],
                  ...
                  exec_env_hijack=st["exec_env_hijack"],
...
def _merge_file(data: dict, fname: str, st: dict) -> None:
    ...
    for key in ("install_review", "mcp_config", "mcp_tool_integrity", "ci_workflow", "git_hooks", "hook_manager",
                "agent_def",
                "skills_protect",
                "shell_persist", "direnv", "package_manifest", "pnpmfile_exec", "git_config_exec",
