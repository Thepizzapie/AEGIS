...
def load_policy(path) -> Policy:
    ...
    st = {
        ...
        "shell_persist": {},
        "direnv": {},
        "package_manifest": {}, "pnpmfile_exec": {}, "yarn_exec": {}, "pep517_backend": {},
        "git_config_exec": {}, "git_attributes_exec": {},
        "gitmodules": {},
    ...
    return Policy(rules=st["rules"], default_action=st["default"],
                  ...
                  pep517_backend=st["pep517_backend"],
...
def _merge_file(data: dict, fname: str, st: dict) -> None:
    ...
    for key in ("install_review", "mcp_config", "mcp_tool_integrity", "ci_workflow", "git_hooks", "hook_manager",
                "agent_def",
                "skills_protect",
                "shell_persist", "direnv", "package_manifest", "pnpmfile_exec", "yarn_exec", "pep517_backend",
                "git_config_exec",
