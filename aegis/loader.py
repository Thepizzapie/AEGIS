...
def load_policy(path) -> Policy:
    ...
    st = {
        ...
        "path_hijack": {}, "claude_hooks": {}, "claude_statusline": {}, "conftest": {}, "pysite": {},
    ...
    return Policy(rules=st["rules"], default_action=st["default"],
                  ...
                  claude_statusline=st["claude_statusline"],
...
def _merge_file(data: dict, fname: str, st: dict) -> None:
    ...
    for key in ("install_review", "mcp_config", "ci_workflow", "git_hooks", "agent_def",
                ...
                "devcontainer_exec",
                "vscode_tasks_exec", "path_hijack", "claude_hooks", "claude_statusline", "conftest", "pysite",
                "ipython_startup", "fetch_to_file",
